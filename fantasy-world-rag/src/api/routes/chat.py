...
async def get_character_engine(character: Character) -> CharacterEngine:
    ...
    if character.id not in _character_engines:
        ...
        personality = PersonalityCore(
            ...
            traits=character.personality_json.get("dominant_traits", []),
...
async def _handle_ws_message(
    ...
    async with get_session() as session:
        ...
        # Send response with Character Engine data
        await manager.send_message(client_id, {
            "type": "response",
            "character_id": character_id,
            "character_name": character.name,
...
async def _generate_response(
    ...
    try:
        ...
        return {
            ...
            "consistency_score": response.consistency_check.overall_score if response.consistency_check else None,
